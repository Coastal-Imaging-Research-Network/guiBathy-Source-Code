...
params.dxm = 25;%12.5;                    % analysis domain spacing in x
params.dym = 50;                    % analysis domain spacing in y
params.xyMinMax = [75 500 0 1000];   % min, max of x, then y
                                    % default to [] for cBathy to choose
params.tideFunction = 'cBathyTide';  % tide level function for evel
% params.h0Function = 'findh0Duck';    % approx bathy function for seed
